...
/**
 *------------------------------------------------------------------------------
 * Remove User - Administrative Section - System access and Alarms Section
 *------------------------------------------------------------------------------
 *
 */
...
$query = "Delete from Alarm_Permissions WHERE userID = :userID and buildingID=:buildingID";
        
        $bind[':userID'] = intval($_GET['id']);
        $bind[':buildingID'] = intval($_GET['BldID']);
